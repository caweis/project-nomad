 ...
 * estimate (from `KbRatioRegistry.estimateBatch`) and the free-disk
 * figure from system info. Pass `freeBytes = 0` to skip the
 * relative-disk check when free space isn't known.
 */
