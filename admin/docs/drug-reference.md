...
Open **Drug Reference** from the home screen. If no data is installed you will get a "No FDA drug data yet" panel with a **Download FDA drug data** button.

It runs in two stages in the background:
...
The Drug Reference is one of the largest single items you can install. Budget around **8 to 10 GB** of disk for it after indexing, on top of the 1.7 GB download.

The "No FDA drug data yet" panel states the sizes before you commit, so you can see what you are taking on.
